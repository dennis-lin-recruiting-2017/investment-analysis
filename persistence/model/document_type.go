...
// DocumentType identifies the kind of document stored in the retrieval system.
// Using a named string type rather than bare strings gives compile-time safety
// and a single place to discover all valid values.
